...
export const siteConfig: SiteConfig = {
  title: 'Lunar Hub Documentations',
  subtitle: 'Documentations site for Lunar Hub Script',
  ...
  banner: {
    ...
    credit: {
      ...
      text: 'kripermana',              // Credit text to be displayed
      url: 'https://github.com/kripermana'                // (Optional) URL link to the original artwork or artist's page
    }
  },
  toc: {
